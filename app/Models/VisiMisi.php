...
class VisiMisi extends Model
{
    ...
    {
        return $this->db->query("SELECT t.*, a.nama_lengkap, a.foto_profil FROM {$this->table} t LEFT JOIN anggota a ON t.id_editor = a.id_anggota ORDER BY t.jenis_konten DESC");
    }
