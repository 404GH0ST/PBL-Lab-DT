...
<div aria-live="polite" aria-atomic="true" class="position-relative">
    <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 1050; margin-top: 60px;">
        <div id="successToast" class="toast align-items-center text-dark bg-light border-success" 
            role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="4000"> 
            
            <div class="d-flex">
                <div class="toast-body d-flex align-items-center">
                    <i class="bi bi-check-circle-fill me-2 fs-5 text-success"></i>
                    <span><strong>Berhasil!</strong> Visi dan Misi berhasil disimpan dan diperbarui.</span>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function updateSubmitButtonState() {
            ...
            if (hasChanged) {
                // Menggunakan btn-primary (ungu) untuk kondisi Ada Perubahan (enabled)
                ...
                // Tetap menggunakan btn-primary (ungu) untuk kondisi Tidak Ada Perubahan (disabled)
                $btn.removeClass('btn-warning btn-danger').addClass('btn-primary');
